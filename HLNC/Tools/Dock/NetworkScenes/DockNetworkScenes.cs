...
[Tool]
public partial class DockNetworkScenes : Control
{
    [Export]
    ...
    {
        Connect("InspectNode", new Callable(this, nameof(OnInspectNode)));
    }
    ...
    public void _OnVisibilityChanged()
    {
        ...
        foreach (var scene in NetworkScenesRegister.ListScenes())
        {
