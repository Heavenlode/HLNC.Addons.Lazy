...
namespace HLNC
{
	...
	*/
	public partial class NetworkNode3D : Node3D, INetworkNode, INotifyPropertyChanged, INetworkSerializable<NetworkNode3D>, IBsonSerializable<NetworkNode3D>
	{
		...
		public static NetworkNode3D BsonDeserialize(Variant context, byte[] bson, NetworkNode3D obj)
		{
			var data = BsonSerializer.Deserialize<BsonDocument>(bson);
			if (data.IsBsonNull) return null;
			var doc = data.AsBsonDocument;
			var node = obj == null ? new NetworkNode3D() : obj;
