...
namespace HLNC.Addons.Lazy
{
    ...
    public partial class LazyPeerState : RefCounted, INetworkSerializable<LazyPeerState>, IBsonSerializable<LazyPeerState>
    {
        ...
        public static LazyPeerState BsonDeserialize(Variant context, byte[] bson, LazyPeerState instance)
        {
            var data = BsonSerializer.Deserialize<BsonValue>(bson);
